...
var MATERIAL_AMBIENT = "material_ambient";
var MATERIAL_DIFFUSE = "material_diffuse";
var MATERIAL_SPECULAR = "material_specular";
...
function createShape()
{
	...
	result[MATERIAL_AMBIENT] = vec4(1.0, 0.0, 1.0, 1.0);
	result[MATERIAL_DIFFUSE] = vec4(1.0, 0.8, 0.0, 1.0);
	result[MATERIAL_SPECULAR] = vec4(1.0, 0.8, 0.0, 1.0);
